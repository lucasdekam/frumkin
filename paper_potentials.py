...
ax_phi_cbulk = fig.add_subplot(gs[0, 0])
ax_phi_gamma = fig.add_subplot(gs[1, 0])
ax_phirp_cbulk = fig.add_subplot(gs[0, 1])
ax_phirp_gamma = fig.add_subplot(gs[1, 1])
ax_cat_cbulk = fig.add_subplot(gs[0, 2])
ax_oh_phbulk = fig.add_subplot(gs[1, 2])
