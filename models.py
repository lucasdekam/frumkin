...
#         self.d_sol_m = 1/self.n_s_0 ** (1/3)

#         self.gamma_c = (d_cat_m / self.d_sol_m) ** 3
#         self.gamma_a = (d_an_m / self.d_sol_m) ** 3

#         self.chi_v = 0.05
#         self.n_max = (self.n_s_0 + (self.gamma_c + self.gamma_a) * self.n_0) / (1 - self.chi_v)
